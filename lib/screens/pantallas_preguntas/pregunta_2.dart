...
class Pregunta2 extends StatefulWidget {
  ...
  @override
  State<Pregunta2> createState() => _Pregunta2State(resultado: null);
}
...
class _Pregunta2State extends State<Pregunta2> {
  ...
  _Pregunta2State({required this.resultado});
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('¿Usa el dedo índice para señalar, para indicar interés por algo o le lleva objetos para mostrar como indicando"mira"?',
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () { Navigator.pushNamed(context ,"pregunta_3", arguments: resultado);},
  ...
  void _saveResponse(String respuesta) async {
    ...
    prefs.setString('Respuesta_2', respuesta);
  }
}