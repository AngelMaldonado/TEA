...
class Pregunta6 extends StatefulWidget {
  ...
  @override
  State<Pregunta6> createState() => _Pregunta6State(resultado: null);
}
...
class _Pregunta6State extends State<Pregunta6> {
  ...
  _Pregunta6State({required this.resultado});
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () { 
                    if(resultado = true){Navigator.pushNamed(context ,"resultadoPositivo");}
                    else {Navigator.pushNamed(context ,"resultadoNegativo");}
                  },
