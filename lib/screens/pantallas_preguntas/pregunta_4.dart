...
class Pregunta4 extends StatefulWidget {
  ...
  @override
  State<Pregunta4> createState() => _Pregunta4State(resultado: null);
}
...
class _Pregunta4State extends State<Pregunta4> {
  ...
  _Pregunta4State({required this.resultado});
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('¿Trata de imitar gestos de otros?',
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () { Navigator.pushNamed(context ,"pregunta_5", arguments: resultado);},
  ...
  void _saveResponse(String respuesta) async {
    ...
    prefs.setString('Respuesta_4', respuesta);
  }
}