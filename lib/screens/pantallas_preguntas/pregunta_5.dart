...
class Pregunta5 extends StatefulWidget {
  ...
  @override
  State<Pregunta5> createState() => _Pregunta5State(resultado: null);
}
...
class _Pregunta5State extends State<Pregunta5> {
  ...
  _Pregunta5State({required this.resultado});
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text('¿Juega adecuadamente con los juguetes y no solo metérselos a la boca, aventarlos, formarlos, insertarlos?',
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () { Navigator.pushNamed(context ,"pregunta_6", arguments: resultado);},
  ...
  void _saveResponse(String respuesta) async {
    ...
    prefs.setString('Respuesta_5', respuesta);
  }
}